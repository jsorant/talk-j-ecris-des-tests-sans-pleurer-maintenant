...
public class TestSuite1 {
  ...
  void test1() {
    ...
    try { // test has no book
      borrowBook.borrow("jeremy.sorant@domain.fr", "1234567891", Instant.parse("2025-04-14T10:00:00Z"));
    ...
    borrowBook.borrow("jeremy.sorant@domain.fr", "1234567890", Instant.parse("2025-04-14T10:00:00Z"));

    assertEquals( // test send email
